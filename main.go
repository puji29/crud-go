...
func postHandler(c *gin.Context, db *gorm.DB) {
	...
	c.JSON(http.StatusOK, gin.H{"message": "succesfully create", "data": newStudent})
}
...
func getAllHandler(c *gin.Context, db *gorm.DB) {
	...
	db.Find(&newStudent)
	c.JSON(http.StatusOK, gin.H{"message": "succesfully find", "data": newStudent})
}
func getHandler(c *gin.Context, db *gorm.DB) {
	...
	c.JSON(http.StatusOK, gin.H{"message": "succesfully find by id", "data": newStudent})
...
func putHandler(c *gin.Context, db *gorm.DB) {
	...
	// // c.JSON(http.StatusInternalServerError, gin.H{"error": err.Error()})
	// }
	// // c.JSON(http.StatusOK, gin.H{"message": "succes update"})
	// }
...
func delHandler(c *gin.Context, db *gorm.DB) {
	...
	// return
	// }
	// // c.JSON(http.StatusOK, gin.H{"message": "succes delete"})
